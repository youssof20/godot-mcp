...
func _enter_tree() -> void:
	activity_log = preload("res://addons/godot_mcp/mcp_activity_log.gd").new()
	...
	websocket_server.activity_log = activity_log
	...
	status_panel.call_deferred("setup", websocket_server, command_router, activity_log)
